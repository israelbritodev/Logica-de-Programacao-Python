...
# # os preços de compra e os percentuais de lucro de 5 produtos. Após a leitura, exiba para cada produto seu nome, o preço de compra e o preço de venda calculado.
